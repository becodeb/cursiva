...
import { ANDEAN_HAT_ART, CARRIER_LENS_ART, SECTOR_ADVENTURE_ART, type ArtImage } from '../detective/assets'
...
/** Three entries: the Andean hat (row C, `docs/13` §2), the lupa and the
 * linterna (row D, design.md §7.1). `llama-peak4` rather than all eight
 ...
 * each is its own adventure's last level, and the caretaking/searching
 * story earns the tool at the exact moment the adventure closes. The
 * Pulpito does not WEAR any of them (design.md §4.4) — a worn accessory
