...
- THEN the test code MUST be unedited and MUST still pass### Requirement: Optional Waypoints Field on LevelConfig Gates the Free Branch's Scoring Path, Preserving revealScore as the Bit-Identical Fallback
